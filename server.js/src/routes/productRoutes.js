...
router.post("/add",authMiddleware.authenticateUser,authMiddleware.vendorOnly, productController.addProduct);
...
router.post("/upload-images", authMiddleware.authenticateUser, authMiddleware.vendorOnly, uploadMiddleware.array("images", 5), productController.uploadProductImages);
