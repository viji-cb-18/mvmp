...
router.post("/upload-store-logo", authMiddleware.authenticateUser, authMiddleware.vendorOnly, uploadMiddleware.single("image"), vendorController.uploadStoreLogo);
